# Impact Hammer Yellow Hit Indicator 

Makes the Impact Hammer hit sound's pitch increase with the number of consecutive hits, and adds steam while the 3 second consecutive hit timer ticks down.

Everything this mod does is configurable. The config options consist of: 
